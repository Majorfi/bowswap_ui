		...
		<Popover>
			<div ref={buttonRef}>
				...
				<Transition
					...
					<Popover.Panel className={'absolute z-30 w-screen max-w-xs px-4 pt-2 transform -translate-x-full left-0 sm:px-0 '}>
