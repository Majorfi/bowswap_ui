...
let Game = {
	initialize: function () {
		this.canvas = document.getElementById('pooong');
		if (!this.canvas) {
			setTimeout(() => Pong.initialize(), 500);
			return;
		}
	...
	draw: function () {
		...
		this.context.strokeStyle = '#0066e1';
		this.context.stroke();
