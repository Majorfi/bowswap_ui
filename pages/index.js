		...
		<div className={'w-full'}>
			<div className={'relative'}>
				<button
					...
					className={'relative w-full py-2 pl-3 pr-10 text-left bg-white rounded-lg border border-gray-200 focus:outline-none cursor-pointer'}>
			...
			<Transition.Root show={open} as={Fragment}>
				<Dialog as={'div'} static className={'fixed z-10 inset-0 overflow-y-auto'} open={open} onClose={set_open}>
						...
						>
							<div className={'inline-block bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all max-w-lg p-6 sm:mb-12 md:mt-24 lg:mt-24'}>
								...
								<div className={'mt-5 sm:mt-6'}>
									<button
										type={'button'}
										className={'inline-flex justify-center w-full rounded-md shadow-sm px-4 py-2 bg-blue-900 text-base font-medium text-white hover:bg-blue-800 focus:outline-none sm:text-sm'}
